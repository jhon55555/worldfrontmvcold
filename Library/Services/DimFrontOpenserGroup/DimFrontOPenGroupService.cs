...
{
    public class DimFrontOPenGroupService : IDimFrontOPenGroupService
    {
        #region Fields
        ...
        public DimFrontOPenGroupService(ISqlClientService sqlClientService)
        {
        ...
        public DataSet Framelogin(Framelogin framelogin)
        {
            ...
            DataSet ds = _sqlClientService.Execute("checkFramelogin", ConfigItems.Conn_Casinogroup, parameters);
        ...
        public DataSet Userexist(Userexist tvata)
        {
            try
            {
                ...
                ds = _sqlClientService.Execute("WolfUserExist", ConfigItems.Conn_AccDgroup, parameters);
